...
# Find aggregates using a Difference of Gaussians detector
# Uses a saved ROI set to collect per-cell data including aggregate count, cell and cytoplasm area
# *** NOTE: ROI set must have same base name as the image! *** 
# ------- REQUIRED ROISet FORMAT ----------t
...
def extract_channel(imp_max, ch1Name, ch2Name, Channel_1, Channel_2):
	...
	# convert each channel into floating-point image processors
